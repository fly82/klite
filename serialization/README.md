...
Please [add kotlinx-serialization and enable its compiler plugin](build.gradle.kts), and optionally kotlinx-datetime as
dependencies of your own project.

## Status

I rather recommend using [json](../json) module instead.
